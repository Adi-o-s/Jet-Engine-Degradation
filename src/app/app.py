...
@app.get('/')
async def root():
    """Basic service info, useful as a landing/health endpoint."""
    return {
        'service': 'Jet Engine Degradation Prediction API',
        'status': 'ok',
        'docs': '/docs',
    }
...
@app.get('/health')
async def health():
    """Liveness probe confirming the model and scaler are loaded."""
