...
def load_test_RUL():
    # The RUL ground-truth file contains a single column: the true RUL for each
    # engine in the test set (one row per engine, in engine-id order).
    return load_data('RUL_FD001.txt', col_names=['RUL'])
